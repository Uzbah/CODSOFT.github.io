...
// function initiateApi(search) {
//   console.log(`https://www.googleapis.com/books/v1/volumes?q="${search}"&maxResults=1`);
...
//           var bookAuthor = document.createElement("h6");
//           bookAuthor.textContent = `by ${book.volumeInfo.authors[0] ? book.volumeInfo.authors[0] : "No title"}`;
//         }

//         const bookDescription = document.createElement("p");
//         bookDescription.classList.add("description");
//         const desc = book.volumeInfo.description ? book.volumeInfo.description : "No description";
...
//         readMoreBtn.appendChild(readMoreBtnText);
//         readMoreBtn.addEventListener("click", (e) => {
//           const remainingDescription = e.target.parentNode.querySelector(".remaining-description");
//           remainingDescription.classList.toggle("remaining-description--show");

//           e.target.textContent = e.target.textContent.includes(" ...Read More") ? " ...Read Less" : " ...Read More";
//         });
...
//         const bookPreviewLink = document.createElement("a");
//         bookPreviewLink.innerHTML = "READ";
//         bookPreviewLink.href = book.volumeInfo.previewLink;
//         bookPreviewLink.target = "blank";

//         const downloadButton = document.createElement("button");
//         downloadButton.classList.add("download", "btn", "btn-outline-secondary");
//         downloadButton.textContent = "DOWNLOAD";
//         downloadButton.addEventListener("click", () => downloadBook(book));

//         bookPreviewLink.classList.add("btn", "btn-outline-secondary");
//         bookCard.classList.add("result", "row");
//         bookCard.setAttribute("data-aos", "fade-up");

//         bookInfo.append(bookTitle, bookAuthor, bookDescription, bookPreviewLink, downloadButton);
//         bookCard.append(bookInfo, bookImageContainer);
//         document.getElementById("results").appendChild(bookCard);
//         document.getElementById("results").scrollIntoView();
//       }
...
//     method: 'POST',
//     headers: {
//       'x-api-key': 'uzbahnaseem90@gmail.com_68858mu27FAcY5IUd179JX9kDUtUUykjGB6A62HrLg63C0W9fSGU444E5OXSCV3A',
//       'Content-Type': 'application/json'
//     },
//     body: JSON.stringify({
//       html: `<html><body>${bookInfo}</body></html>`
//     })
//   })
